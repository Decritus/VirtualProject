...
public class GBoardComputer extends GBoard implements ActionListener {
	...
	private void setButtons(int iSize) {
		...
		ImageIcon iconWater = new ImageIcon(System.getProperty("user.dir")+"/src/juegos/GBoard/water.jpg");
	...
	private void finishHit() {
		...
		myGame.computerTurn(); // Say to the game that finished playing with it,
								// and it´s the turn of the computer
	}
}