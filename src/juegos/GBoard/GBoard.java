...
abstract public class GBoard extends JPanel  
{
	...
	{
		ImageIcon iconLeft = new ImageIcon(System.getProperty("user.dir")+"/src/juegos/GBoard/imagesLeft.gif");
		ImageIcon iconCentre = new ImageIcon(System.getProperty("user.dir")+"/src/juegos/GBoard/Centre.gif");
		ImageIcon iconRight = new ImageIcon(System.getProperty("user.dir")+"/src/juegos/GBoard/GBoard/Right.gif");
	...
	{
		ImageIcon iconTop = new ImageIcon(System.getProperty("user.dir")+"/src/juegos/GBoard/Top.gif");
		ImageIcon iconCentre = new ImageIcon(System.getProperty("user.dir")+"/src/juegos/GBoard/Centre2.gif");
		ImageIcon iconBottom = new ImageIcon(System.getProperty("user.dir")+"/src/juegos/GBoard/Bottom.gif");
	...
	{
		ImageIcon iconWater = new ImageIcon(System.getProperty("user.dir")+"/src/juegos/GBoard/fail.jpg");
	...
	{	int s;
		...
		ImageIcon iconWater = new ImageIcon(System.getProperty("user.dir")+"/src/juegos/GBoard/touch.jpg");
		buttons[x][y].setIcon(iconWater);
