...
*/
	...
	public void actionPerformed(ActionEvent event)
	{
			...
			if(event.getActionCommand().equals("Salir")){
				    ...
				    try {
				    	//esto se llama cuando termina el juego
				    	
						casino.acabado(dinero, usuario);
	...
	@Override
	public void ponerSaldo(int d, UsuarioActivado usuario) {
