...
public class AdministradorDAO {
	public static Administrador loadAdministradorByORMID(int idPersonal) throws PersistentException {
		try {
			PersistentSession session = basededatos.CasinoVirtualMDS2PersistentManager.instance().getSession();
			return loadAdministradorByORMID(session, idPersonal);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Administrador getAdministradorByORMID(int idPersonal) throws PersistentException {
		try {
			PersistentSession session = basededatos.CasinoVirtualMDS2PersistentManager.instance().getSession();
			return getAdministradorByORMID(session, idPersonal);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(int idPersonal, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = basededatos.CasinoVirtualMDS2PersistentManager.instance().getSession();
			return loadAdministradorByORMID(session, idPersonal, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(int idPersonal, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = basededatos.CasinoVirtualMDS2PersistentManager.instance().getSession();
			return getAdministradorByORMID(session, idPersonal, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int idPersonal) throws PersistentException {
		try {
			return (Administrador) session.load(basededatos.Administrador.class, new Integer(idPersonal));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int idPersonal) throws PersistentException {
		try {
			return (Administrador) session.get(basededatos.Administrador.class, new Integer(idPersonal));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador loadAdministradorByORMID(PersistentSession session, int idPersonal, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.load(basededatos.Administrador.class, new Integer(idPersonal), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Administrador getAdministradorByORMID(PersistentSession session, int idPersonal, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Administrador) session.get(basededatos.Administrador.class, new Integer(idPersonal), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(basededatos.Administrador administrador) throws PersistentException {
		try {
			basededatos.CasinoVirtualMDS2PersistentManager.instance().saveObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(basededatos.Administrador administrador) throws PersistentException {
		try {
			basededatos.CasinoVirtualMDS2PersistentManager.instance().deleteObject(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(basededatos.Administrador administrador) throws PersistentException {
		try {
			basededatos.CasinoVirtualMDS2PersistentManager.instance().getSession().refresh(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(basededatos.Administrador administrador) throws PersistentException {
		try {
			basededatos.CasinoVirtualMDS2PersistentManager.instance().getSession().evict(administrador);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
