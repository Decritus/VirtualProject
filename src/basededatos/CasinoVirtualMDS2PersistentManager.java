...
public class CasinoVirtualMDS2PersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "CasinoVirtualMDS2";
	...
	private CasinoVirtualMDS2PersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new CasinoVirtualMDS2PersistentManager();
		}
